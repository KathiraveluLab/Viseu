package edu.emory.viseu.overlay.csv.core;

import com.opencsv.bean.ColumnPositionMappingStrategy;
import com.opencsv.bean.CsvToBean;
import com.opencsv.bean.CsvToBeanBuilder;
import com.opencsv.exceptions.CsvValidationException;
import edu.emory.viseu.overlay.csv.scanner_util.FilterCsvBean;
import edu.emory.viseu.overlay.csv.scanner_util.IntermediaryCsvBean;
import edu.emory.viseu.overlay.csv.scanner_util.ScannerUtil;
...
public class CsvReader {
    ...
    public static void readIntermediaryCSVFolder() throws IOException {
        File folder = new File(ViseuConstants.INTERMEDIARY_CSV_DIRECTORY);
        File subset = new File(ViseuConstants.SUBSET_SCANNERS);
        int index = 1;
